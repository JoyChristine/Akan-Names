...
// //var century = Math.floor(((yr -1) / 100 -1));
...
//     var mnth = parseInt(document.getElementById("inputMonth").value);
//     var dy = parseInt(document.getElementById("inputDay").value);
//     let dateOfBirth = new Date(yr + "/" + month + "/" + day);
//     let results = dateOfBirth.getDay();
//     //var century = Math.floor(((yr -1) / 100 -1));
//     //var formula = (((century / 4) - 2 * century - 1 ) + ((5 * yr / 4)) + (( 26 * (mnth + 1) / 10)) + dy) % 7;
//     //var dayResult = Math.round(formula);
...
//             if(dy> 0 && dy <32) {
//                 if(male) {
//                     document.getElementById("result").innerHTML = ("You were born on " + daysOfWeek[results] +" " + "&" + " " + "your Akan name is " + " "+ " "+ maleNames[results]);
 
//                 }else if(female) {
                    
//                     document.getElementById("result").innerHTML = ("You were born on " + daysOfWeek[results] + " " + "&" + " " + "your Akan name is " + " "+ " "+ femaleNames[results]);
//                 }
...
//     DayOfTheWeek = (((century / 4)- 2 * century-1) + (( 5 * YY / 4)) + ((26 * ( MM+ 1) / 10)) + DD) % 7;
